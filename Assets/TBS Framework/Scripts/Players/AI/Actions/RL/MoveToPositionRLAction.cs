...
{
    public class MoveToPositionRLAction : RLAction
    {
        public bool ShouldMoveAllTheWay = true;
        public Cell TopDestination { get; private set; } = null;
        ...
        public override bool ShouldExecute(Player player, Unit unit, CellGrid cellGrid)
        {
            ...
            cellScores = cellGrid.Cells.Select(c => (cell: c, value: evaluators.Select(e =>
            {
                ...
                if ((player as RLPlayer)?.debugMode ?? false)
                {
        ...
        public override void CleanUp(Player player, Unit unit, CellGrid cellGrid)
        {
            ...
            TopDestination = null;
            (cellGrid.cellGridState as CellGridStateRLTurn)?.CellDebugInfo?.Clear();
        }
        ...
        public override void ShowDebugInfo(Player player, Unit unit, CellGrid cellGrid)
        {
            ...
            {
                cellDebugInfo[TopDestination] = new DebugInfo(cellMetadata[TopDestination], Color.magenta);
            }
            
            (cellGrid.cellGridState as CellGridStateRLTurn).CellDebugInfo = cellDebugInfo;
