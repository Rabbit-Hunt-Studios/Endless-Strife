...
namespace TbsFramework.Units
{
    public class EndlessUnit : Unit
    {
        ...
        {
            return damage - (Cell as EndlessSquare).DefenceBoost;
        }
        ...
        {
            return base.IsCellTraversable(cell) || (cell.CurrentUnits.Count > 0 && !cell.CurrentUnits.Exists(u => !(u as EndlessUnit).isStructure && u.PlayerNumber != PlayerNumber));
        }
